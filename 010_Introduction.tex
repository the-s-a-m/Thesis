...
The implemented clusters are measurements \ref{sec:measurements-cluster-analysis} based on the suggestions \ref{sec:clusterRating} provided by the ETH-Zurich. For further use the results can now be exported into a JSON-File. %TODO more here
