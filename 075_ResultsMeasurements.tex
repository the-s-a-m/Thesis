...
\begin{itemize}
    ...
    \item Modify Output \ref{sec:outout_modification}: no
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Dijkstra Parallel:} The same as the previous but the Dijkstra algorithm runs are executed parallelised.
\end{itemize}
