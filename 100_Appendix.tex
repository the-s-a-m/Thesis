...
Graphical user interface (GUI) components were inserted into the sub-project Synthesis\_WPF\_MVVM. These dialogs were created in the sub folder \textit{Dialogs}:
...
Algorithms were inserted into the sub-project Optimization. These classes have been created for this thesis:
\begin{itemize}
