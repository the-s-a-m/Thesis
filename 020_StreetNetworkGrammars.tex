...
A point based space syntax is a decision based approach. Every time a point in a street network is visited the visitor can decide witch direction he will travel next. The distances between two point can directly be measured and described. 

Bin Jiang and Christope Claramunt \citep{integrationSpaceSyntaxGIS:2002} created a graph representation (\citep{integrationSpaceSyntaxGIS:2002} chapter: 3) and showed that it was at least equivalent to the predefined syntax created by B. Hiller et al.\citep{spaceSyntax:1976}.
