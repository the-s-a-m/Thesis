...
\subsection{Shape Grammar} \label{sec:shape_grammar}
...
\pagebreak
\subsection{L-Systems} \label{sec:L-Systems}
...
\pagebreak
\subsection{Space Syntax} \label{sec:space_syntax}
...
\subsubsection{Axial line-based space syntax and limitations}
...
\subsubsection{Point-based space syntax}
...
\paragraph{Comparison with CPlan}
