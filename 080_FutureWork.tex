...
Despite many cluster analysis approaches where tests in this thesis, other methods like distribution-based or density-based clustering exist. In future works the approaches could be tested and compared. %TODO Janis please more here
