...
%TODO Explain hierarchy output and how to create clusters from it
...
In some cases the hierarchical clustering has an output of clusters with highly varying size. (Size meaning the node / street junction count in this context.) In figure \ref{fig:unmodified_cluster_size} a clustering of Weimar with such a case is shown. In this figure there is a relatively big cluster in the centre of the city and at the bottom left are multiple very small clusters.
...
%TODO rephrase to match explanation about hierarchy output
